...
import {IsString, IsNotEmpty, IsEmail, Matches} from "class-validator";// các decorator để validate dữ liệu đầu vào như @IsEmail để kiểm tra xem trường đó có phải là email hay không, @IsString để kiểm tra xem trường đó có phải là chuỗi hay không
